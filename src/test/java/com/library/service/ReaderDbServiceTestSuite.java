...
public class ReaderDbServiceTestSuite {
    ...
    public void saveReaderTest() {
        //Given
        List<Reader> readersBeforeSave = readerDbService.getAllReaders();

        //When
        readerDbService.saveReader(reader1);
        Long id = reader1.getId();
        List<Reader> readersAfterSave = readerDbService.getAllReaders();
        Optional<Reader> readerOptional = readerDbService.getReaderById(id);
    ...
    public void findAllReadersTest() {
        ...
        readerDbService.saveReader(reader3);
    ...
    public void deleteReaderTest() {
        ...
        //When
        List<Reader> readersBeforeDelete = readerDbService.getAllReaders();
        readerDbService.deleteById(id);
        List<Reader> readersAfterDelete = readerDbService.getAllReaders();
        Optional<Reader> readerOptional = readerDbService.getReaderById(id);
